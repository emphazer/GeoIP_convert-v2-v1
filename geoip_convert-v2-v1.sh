...
mkdir $DATE_TODAY && cd $DATE_TODAY && (
        ...
        pip install ipaddr pygeoip &>/dev/null
        ...
        sed -i -r '/csv2dat.py [0-9]{8} Build/ s@csv2dat.py [0-9]{8}@'${NAME:-Custom}' '${DATE_TODAY:-20180000}'@' csv2dat.py
        ...
        ./mmdb-convert.py GeoLite2-Country_*/GeoLite2-Country.mmdb
        ...
        ./csv2dat.py -w GeoIP.dat mmcountry GeoIPC.csv
